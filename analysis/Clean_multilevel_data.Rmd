...
`r sum(removed_fix$removed_PSCID_from_sample)` infants, 
`r sum(removed_fix$removed_vis_from_sample)` eye-tracking visits, 
...
Finally, .... ata from an additional 
`r sum(removed_r2$removed_PSCID_from_sample)` infants, 
`r sum(removed_r2$removed_vis_from_sample)` eye-tracking visits, 
