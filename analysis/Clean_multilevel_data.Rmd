...
h = h %>%
  ...
  mutate(min_hq_posonly= pmin(`Hq0`, `Hq+1`, `Hq+3`, `Hq+5`),
         max_hq_posonly = pmax(`Hq0`, `Hq+1`, `Hq+3`, `Hq+5`),
         min_hq= pmin(`Hq-5`, `Hq-3`, `Hq-1`, `Hq0`, `Hq+1`, `Hq+3`, `Hq+5`),
         max_hq = pmax(`Hq-5`, `Hq-3`, `Hq-1`, `Hq0`, `Hq+1`, `Hq+3`, `Hq+5`),
         spect_width_posonly = max_hq_posonly - min_hq_posonly,
