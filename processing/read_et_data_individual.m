function [success] = read_et_data_individual(id, dataDir, varargin)
...
disp(['Looking for ' id '.txt']);

txtFileName = [id '.txt']; % Name of .txt file script looks for
...
if isfile([id '_rawData.mat']) && ~overwrite
