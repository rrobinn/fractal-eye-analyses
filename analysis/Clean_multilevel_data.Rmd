...
#########################
# Import AOI-based analyses output 
#########################
...
# Note: can clean this up in the future 
...
CalVerMaster = CalVerMaster %>%
  filter(Type != 'NA' )
# Type keeps track of when the calibration verification procedure took place 
